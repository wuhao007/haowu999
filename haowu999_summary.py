...
<body>
    ...
    <div id="tab-portfolio" class="tab-view container py-5 mt-4 text-center">
        ...
        <div class="card bg-dark border-primary p-4 rounded-4 shadow mb-4">
            <div class="text-secondary small">5 年蒙特卡洛财富路径 (95% CI)</div>
    ...
    <script>
        ...
        function calcVault() {
            ...
            if(total > 0) {
                ...
                let high = total * Math.exp((0.15 - 0.5 * avgVol**2) * 5 + 1.96 * avgVol * Math.sqrt(5));
                document.getElementById('v-mc').innerText = '$' + low.toLocaleString(0) + ' ~ $' + high.toLocaleString(0);
            }
        }
